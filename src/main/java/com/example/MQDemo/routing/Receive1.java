...
public class Receive1 {
    public static final String QUEUE_NAMW = "test_queue_rout_mail";//同一条消息既要被邮件消费者消费，也要被短信业务消费
    ...
    public static void main(String[] args) throws Exception {
        ...
        channel.queueBind(QUEUE_NAMW ,EXCHANGE_NAME ,"info");
        channel.queueBind(QUEUE_NAMW ,EXCHANGE_NAME ,"error");
        channel.basicQos(1);
